                ...
                <div className="flex-1 bg-gray-100 p-8">
                    ...
                    <div className='p-4'>
                        <div className='w-[600px] bg-white rounded-md mb-8 mt-4 p-4'>
                            <div className='flex w-[200px] py-1 item-center gap-3 rounded-full px-3 bg-green-500'>
                                <img src="/icon-check.png" width={16} alt="" />
                                <p className='text-xs text-white'>Terkonfirmasi</p>
                            </div>
                            ...
                            <div className='flex items-center justify-between gap-4 mt-4'>
                                ...
                                <div >
                                    <div className='flex gap-4 mr-4'>
                                        <Link href="/dashboard/terkonfirmasi/pindah-jadwal">
                                            <div>
                                                <img src="/pindah-jadwal.png" alt="" />
                                                <p className='text-xs text-center text-gray-500'>Pindah</p>
                                            </div>
                                        </Link>
                                        <Link href="/dashboard/terkonfirmasi/form-batal">
                                            <div>
                                                <img src="/batal-reservasi.png" alt="" />
                                                <p className='text-xs text-gray-500 text-center'>Batalkan</p>
                                            </div>
                                        </Link>
                                    </div>
                                </div>
